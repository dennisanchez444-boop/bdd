...
--ACTUALIZAR todas las descripciones de los videojuegos vuya valoracion sea mayor a 9 por "Mejor Puntuacion"
select * from videojuegos;
update videojuegos set descripcion = 'Mejor puntuado' where valoracion > 9
--ELIMINAR los videojuegos cuya valoracion sea menor que 7
